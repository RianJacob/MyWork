// This program demonstrates the Car, Trucl, and SUV
// class that are derived from the Automobile clas.
#include <iostream>
#include <iomanip>
#include "Car.h"
#include "Truck.h"
...
int main()
{
  ...
  SUV suv("Volvo", 2005, 30000, 18000.0, 5);
    ...
    // Display the autombiles we have in inventory.
  ...
  cout<< "We have the folowing truck in inventory:\n"
